...
class PrivateTagsAPITests(TestCase):
    ...
    def test_tags_limited_to_user(self):
        """Test list of tags is limited to autthenticated user"""
        other_user = create_user(email='test41@example.com')
    ...
    def test_update_tag(self):
        ...
        payload = {'name': 'Pizzas and Hamburgers'}
    ...
    def test_delete_tag(self):
        tag = Tag.objects.create(user=self.user, name='Sushi')
    ...
    def test_filtered_tags_unique(self):
        ...
        Tag.objects.create(user=self.user, name='Chips')
        ...
        recipe2 = Recipe.objects.create(
            title='Alfredo Chicken Fettucini',
            time_minutes=25,
            price=Decimal('11.99'),
            user=self.user
        )
